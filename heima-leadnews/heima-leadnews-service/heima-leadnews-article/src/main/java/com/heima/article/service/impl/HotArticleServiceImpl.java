...
public class HotArticleServiceImpl implements HotArticleService {
    ...
    private void cacheTagToRedis(List<HotArticleVo> hotArticleVoList) {
        ...
        if(responseResult.getCode().equals(200)){
            ...
            if(wmChannels != null && wmChannels.size() > 0){
                for (WmChannel wmChannel : wmChannels) {
                    ...
                    sortAndChche(hotArticleVos, ArticleConstants.HOT_ARTICLE_FIRST_PAGE + wmChannel.getId());
                }
            }
        }
        ...
        //设置推荐数据
        //给文章进行排序，取30条分值较高的文章存入redis  key：频道id  value：30条分值较高的文章
        sortAndChche(hotArticleVoList, ArticleConstants.HOT_ARTICLE_FIRST_PAGE + ArticleConstants.DEFAULT_TAG);
    }
     ...
     * @param key
     */
    private void sortAndChche(List<HotArticleVo> hotArticleVos, String key) {
